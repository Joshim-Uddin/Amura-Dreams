...
console.log(totalPages)
    ...
    return (
        <div>
            ...
            <div className="products px-32">
                ...
                <div className='charm text-3xl cursor-pointer' onClick={()=>setFilter(!filter)}>
                <input type="button" value="Filtros"  /> <span>{filter?"▲":"▼"}</span>
                </div>
                <p className='charm text-3xl'>Ayudame a encontrar mi aroma ⓘ</p>
                </div>
                <div className={filter?"flex justify-between":""}>
                <div className={filter?'filter block z-30 mt-24':'filter hidden'}>
    <div>
        <h3 className='text-4xl mb-5 capitalize'>Colecciones</h3>
        <div className="check">
    ...
    <div className='mt-16'>
        <h3 className='text-4xl mb-5 capitalize'>Notas</h3>
        <div className="check">
        ...
        <label htmlFor="balsamos">balsamos</label>
                ...
                <div className={filter?'w-3/4 grid grid-cols-2 gap-x-24 gap-y-14 pt-14':'grid grid-cols-3 gap-x-24 gap-y-14 pt-14'}>
